...
final class BrowserPaneNavigationKeybindUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/phatmux-ui-test-goto-split-\(UUID().uuidString).json"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocused() {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["PHATMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocusedUsingGhosttyConfigKeybind() {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["PHATMUX_SOCKET_PATH"] = socketPath
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_USE_GHOSTTY_CONFIG"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testEscapeRestoresFocusedPageInputAfterCmdL() {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["PHATMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_INPUT_SETUP"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testCmdFFocusesBrowserFindFieldAfterCmdDCmdLNavigation() {
        let app = XCUIApplication()
        app.launchEnvironment["PHATMUX_SOCKET_PATH"] = socketPath
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_RECORD_ONLY"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        launchAndEnsureForeground(app)

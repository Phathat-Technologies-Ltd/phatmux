...
final class UpdatePillUITests: XCTestCase {
    ...
    func testUpdatePillShowsForAvailableUpdate() {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_UPDATE_STATE"] = "available"
    ...
    func testDetectedBackgroundUpdateShowsPillWithoutManualCheck() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["PHATMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_DETECTED_UPDATE_VERSION"] = "9.9.9"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsForNoUpdateThenDismisses() {
        ...
        let timingPath = FileManager.default.temporaryDirectory
            .appendingPathComponent("phatmux-ui-test-timing-\(UUID().uuidString).json")
        let app = XCUIApplication()
        app.launchEnvironment["PHATMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_UPDATE_STATE"] = "notFound"
        app.launchEnvironment["PHATMUX_UI_TEST_TIMING_PATH"] = timingPath.path
        launchAndActivate(app)
    ...
    func testCheckForUpdatesShowsLoadingThenNoUpdateInSidebarFooter() {
        ...
        let app = launchAppWithMockFeed(
            ...
            version: "9.9.9",
            extraEnvironment: [
                "PHATMUX_UI_TEST_MOCK_FEED_DELAY_MS": "7000",
            ]
        )
    ...
    func testNoSparklePermissionDialogIsShown() {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_RESET_SPARKLE_PERMISSION"] = "1"
        launchAndActivate(app)
    ...
    private func launchAppWithMockFeed(
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_FEED_MODE"] = mode
        app.launchEnvironment["PHATMUX_UI_TEST_UPDATE_VERSION"] = version
        app.launchEnvironment["PHATMUX_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_TRIGGER_UPDATE_CHECK"] = "1"
        if let timingPath {
            app.launchEnvironment["PHATMUX_UI_TEST_TIMING_PATH"] = timingPath.path
        }

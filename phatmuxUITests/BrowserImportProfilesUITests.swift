...
final class BrowserImportProfilesUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        capturePath = "/tmp/phatmux-ui-test-browser-import-\(UUID().uuidString).json"
    ...
    private func launchApp() -> XCUIApplication {
        ...
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_FIXTURE"] = #"{"browserName":"Helium","profiles":["You","austin"]}"#
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_DESTINATIONS"] = #"["Default"]"#
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_MODE"] = "capture-only"
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_CAPTURE_PATH"] = capturePath
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_HINT_VARIANT"] = "inlineStrip"
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_HINT_SHOW"] = "1"
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["PHATMUX_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"

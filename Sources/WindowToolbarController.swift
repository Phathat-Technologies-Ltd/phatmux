...
final class WindowToolbarController: NSObject, NSToolbarDelegate {
    private let commandItemIdentifier = NSToolbarItem.Identifier("phatmux.focusedCommand")
    ...
    private func attach(to window: NSWindow) {
        ...
        let toolbar = NSToolbar(identifier: NSToolbar.Identifier("phatmux.toolbar"))

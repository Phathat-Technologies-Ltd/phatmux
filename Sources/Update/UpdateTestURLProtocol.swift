...
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "phatmux.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/phatmux-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["PHATMUX_UI_TEST_FEED_MODE"] ?? "available"
        ...
        <rss version="2.0"
          ...
          <channel>
            <title>phatmux Test Updates</title>

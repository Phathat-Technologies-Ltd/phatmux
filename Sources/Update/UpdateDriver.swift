...
class UpdateDriver: NSObject, SPUUserDriver {
    ...
    func show(_ request: SPUUpdatePermissionRequest,
        ...
        if env["PHATMUX_UI_TEST_TRIGGER_UPDATE_CHECK"] == "1" || env["PHATMUX_UI_TEST_AUTO_ALLOW_PERMISSION"] == "1" {
...
#endif
        // Never show Sparkle's permission UI. phatmux always enables scheduled checks and keeps
    ...
    func showUpdateReleaseNotes(with downloadData: SPUDownloadData) {
        // phatmux uses Sparkle's UI for release notes links instead.
    }
    ...
    func showUpdateInFocus() {
        // No-op; phatmux never shows Sparkle dialogs.
    }

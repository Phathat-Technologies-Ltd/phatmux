...
final class UpdateLogStore {
    ...
    private let queue = DispatchQueue(label: "phatmux.update.log")
    ...
    private init() {
        ...
        logURL = logsDir.appendingPathComponent("Logs/phatmux-update.log")
        ensureLogFile()
    }
...
final class FocusLogStore {
    ...
    private let queue = DispatchQueue(label: "phatmux.focus.log")
    private var entries: [String] = []
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        logURL = logsDir.appendingPathComponent("Logs/phatmux-focus.log")
        ensureLogFile()
    }

export const testimonials = [
  ...
  },
  {
    ...
    text: "phatmux 良さそうすぎてついにバイバイ VSCode するときなのかもしれない",
    lang: "ja",
  ...
  },
  {
    ...
    text: "phatmux良さそうなので入れてみたけれど、良い",
    lang: "ja",
  ...
  },
  {
    ...
    text: "年初にWarpからGhosttyに乗り換えたけど、今はphatmuxに乗り換えた\uD83D\uDCBB 垂直タブが便利で、Claude Codeのタスクの終了が通知されるのがありがたい。Ghosttyベースだから爆速動作はそのまま。ghosttyでやったブランチ表示や補完もそのまま使える",
    lang: "ja",

  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-2xl mx-auto px-6 py-10">
        ...
        {/* Download button */}
        <a
          href="https://github.com/Phathat-Technologies-Ltd/phatmux/releases/download/nightly/phatmux-nightly-macos.dmg"
        ...
        >
          {t.rich("warning", {
            githubLink: (chunks) => (
              <a
                href="https://github.com/Phathat-Technologies-Ltd/phatmux/issues"
                target="_blank"

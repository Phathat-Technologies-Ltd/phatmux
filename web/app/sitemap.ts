...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = [
    ...
    { path: "/blog/introducing-phatmux", lastModified: "2026-02-12", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/zen-of-phatmux", lastModified: "2026-02-27", changeFrequency: "monthly" as const, priority: 0.7 },

...
def _find_cli_binary() -> str:
    ...
    fixed = os.path.expanduser(
        "~/Library/Developer/Xcode/DerivedData/phatmux-tests-v2/Build/Products/Debug/phatmux"
    )
...
<!doctype html>
<html>
  <head><title>phatmux-browser-cli-regression</title></head>
  <body>
    <main>
...
""".strip()
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="phatmux-browser-screenshot-cli-")) / "nested" / "dir"

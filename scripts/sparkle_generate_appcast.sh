...
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-https://github.com/Phathat-Technologies-Ltd/phatmux/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-https://github.com/Phathat-Technologies-Ltd/phatmux/releases/tag/$TAG}"

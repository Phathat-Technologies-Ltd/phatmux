...
def test_goto_split_from_loaded_browser(client: phatmux) -> tuple[bool, str]:
    """
...
def test_goto_split_roundtrip_loaded_browser(client: phatmux) -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    print("=" * 60)
    print("phatmux Browser goto_split Regression Test")
    print("=" * 60)
    print()
    ...
    try:
        with phatmux(socket_path=socket_path) as client:

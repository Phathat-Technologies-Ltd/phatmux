#!/usr/bin/env python3
"""
Regression test: `phatmux claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="phatmux-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `phatmux claude-teams --help` exited non-zero")
    ...
    print("PASS: phatmux claude-teams forwards --help to Claude")
    return 0

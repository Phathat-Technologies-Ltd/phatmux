...
def wait_for_text(client: phatmux, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "phatmux drop [image] #1 (a).png").resolve()
    p2 = (tmp / "phatmux drop second & file!.jpg").resolve()

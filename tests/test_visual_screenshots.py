...
def verify_views_in_window(client: phatmux, label: str = "", timeout: float = 8.0) -> Optional[str]:
...
def _close_and_verify(client: phatmux, change: StateChange, close_idx: Union[int, str],

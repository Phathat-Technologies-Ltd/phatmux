...
- use a v2 JSON client (`tests_v2/phatmux.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh phatmux-vm 'cd /Users/phatmux/GhosttyTabs && ./scripts/run-tests-v1.sh'`
- v2: `ssh phatmux-vm 'cd /Users/phatmux/GhosttyTabs && ./scripts/run-tests-v2.sh'`

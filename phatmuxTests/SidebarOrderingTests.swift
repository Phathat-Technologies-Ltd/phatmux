        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                ...
                second: pullRequestState(
                    number: 18,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/phatmux/-/merge_requests/18",
                    status: .open
                ),
                ...
                fourth: pullRequestState(
                    number: 92,
                    label: "PR",
                    url: "https://bitbucket.org/manaflow/phatmux/pull-requests/92",
                    status: .closed
                )
            ],
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                ...
                second: pullRequestState(
                    number: 42,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/phatmux/-/merge_requests/42",
                    status: .open
                )
            ],
...
final class TerminalControllerSidebarDedupeTests: XCTestCase {
    ...
    func testNormalizeReportedDirectoryTrimsWhitespace() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("   /Users/phatmux/project   "),
            "/Users/phatmux/project"
        )
    }

    func testNormalizeReportedDirectoryResolvesFileURL() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("file:///Users/phatmux/project"),
            "/Users/phatmux/project"
        )
    }

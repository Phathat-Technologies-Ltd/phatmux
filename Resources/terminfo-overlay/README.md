# phatmux terminfo overlay

phatmux ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in phatmux has differed from Ghostty's app renderer in how it treats
